...
const Busqueda = () => {
    const { modalBuscador, handleShowModalBuscador, proyectos } = useProyectos();
    ...
    return (
        <Transition.Root show={ modalBuscador } as={Fragment} afterLeave={ () => setBusqueda('') }>
            <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto mt-20 p-4 sm:p-20 md:p-20" onClose={ handleShowModalBuscador }>
                <Transition.Child
                    as={Fragment}
