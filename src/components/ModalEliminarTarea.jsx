...
const ModalEliminarTarea = () => {
    ...
    const { alerta, modalEliminarTarea, handleEliminarTarea, eliminarTarea } = useProyectos();
    const { msg } = alerta
    return (
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <p className='text-sm text-gray-500'> ¡Atención! Una tarea eliminada no podrá ser recuperada</p>
                                </div>
                            </div>
