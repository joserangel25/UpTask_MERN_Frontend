...
const ModalEliminarColaborador = () => {
    ...
    const { alerta, modalEliminarColaborador ,handleModalEliminarColaborador, eliminarColaborador } = useProyectos();
    const { msg } = alerta
    return (
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <p className='text-sm text-gray-500'> ¡Atención! Una vez eliminado esta persona no podrá acceder al proyecto.</p>
                                </div>
                            </div>
